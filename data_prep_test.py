...
raw_df = pd.read_csv("data/test_set.csv")
...
with open("data/le_bike_id.pkl", "rb") as f:
    le_bike_id = pickle.load(f)
...
with open("data/le_trip.pkl", "rb") as f:
    le_trip = pickle.load(f)
...
with open("data/le_start_s.pkl", "rb") as f:
    le_start_s = pickle.load(f)
raw_df["start_station"] = le_start_s.fit_transform(raw_df["start_station"])
with open("data/le_end_s.pkl", "rb") as f:
    le_end_s = pickle.load(f)
...
raw_df.to_csv("data/cool_test_data.csv", index=False)
